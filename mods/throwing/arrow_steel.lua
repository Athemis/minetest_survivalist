...
minetest.register_node("throwing:arrow_steel_box", {
	...
	tiles = {"throwing_arrow_steel.png", "throwing_arrow_steel.png", "throwing_arrow_back.png", "throwing_arrow_steel_front.png", "throwing_arrow_steel_2.png", "throwing_arrow_steel.png"},
...
THROWING_ARROW_ENTITY.on_step = function(self, dtime)
	...
	if self.lastpos.x~=nil then
		if node.name ~= "air" then
			minetest.env:add_item(self.lastpos, 'throwing:arrow_steel')
			self.object:remove()
		end
	end
