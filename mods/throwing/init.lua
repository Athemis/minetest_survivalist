arrows = {
	{"throwing:arrow_flint", "throwing:arrow_flint_entity"},
...
dofile(minetest.get_modpath("throwing").."/arrow_flint.lua")
dofile(minetest.get_modpath("throwing").."/arrow_steel.lua")
